...
@Ankit.on(events.NewMessage(pattern=r"^[?!]purge"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[!?/]spurge"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[!?/]del$"))
@is_admin
...
@Ankit.on(events.callbackquery.CallbackQuery(data="purges"))
async def _(event):
