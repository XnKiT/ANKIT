...
from Ankit.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Ankit.helpers.thumbnail import gen_thumb
...
@Ankit.on(events.callbackquery.CallbackQuery(data="cls"))
async def _(event):
...
#play
@Ankit.on(events.NewMessage(pattern="^[?!/]play"))
...
#end
@Ankit.on(events.NewMessage(pattern="^[/?!]end"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[?!/]vplay"))
...
#playlist
@Ankit.on(events.NewMessage(pattern="^[?!/]playlist"))
@is_admin
...
#leavevc
@Ankit.on(events.NewMessage(pattern="^[?!/]leavevc"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[?!/]skip"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[?!/]pause"))
@is_admin
...
@Ankit.on(events.NewMessage(pattern="^[?!/]resume"))
@is_admin
